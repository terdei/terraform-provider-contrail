...
const (
	service_connection_module_e2_service int = iota
...
func (obj *ServiceConnectionModule) SetE2Service(value string) {
	...
	obj.modified.SetBit(&obj.modified, service_connection_module_e2_service, 1)
}
...
func (obj *ServiceConnectionModule) SetServiceType(value string) {
	...
	obj.modified.SetBit(&obj.modified, service_connection_module_service_type, 1)
}
...
func (obj *ServiceConnectionModule) SetIdPerms(value *IdPermsType) {
	obj.id_perms = *value
	obj.modified.SetBit(&obj.modified, service_connection_module_id_perms, 1)
}
...
func (obj *ServiceConnectionModule) SetPerms2(value *PermType2) {
	obj.perms2 = *value
	obj.modified.SetBit(&obj.modified, service_connection_module_perms2, 1)
}
...
func (obj *ServiceConnectionModule) SetAnnotations(value *KeyValuePairs) {
	...
	obj.modified.SetBit(&obj.modified, service_connection_module_annotations, 1)
}
...
func (obj *ServiceConnectionModule) SetDisplayName(value string) {
	...
	obj.modified.SetBit(&obj.modified, service_connection_module_display_name, 1)
}

func (obj *ServiceConnectionModule) readServiceObjectRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_connection_module_service_object_refs) == 0) {
...
func (obj *ServiceConnectionModule) AddServiceObject(
	...
	if obj.modified.Bit(service_connection_module_service_object_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, service_connection_module_service_object_refs, 1)
	return nil
}
...
func (obj *ServiceConnectionModule) ClearServiceObject() {
	if (obj.valid.Bit(service_connection_module_service_object_refs) != 0) &&
		(obj.modified.Bit(service_connection_module_service_object_refs) == 0) {
		obj.storeReferenceBase("service-object", obj.service_object_refs)
	}
	obj.service_object_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, service_connection_module_service_object_refs, 1)
	obj.modified.SetBit(&obj.modified, service_connection_module_service_object_refs, 1)
}
...
func (obj *ServiceConnectionModule) readTagRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_connection_module_tag_refs) == 0) {
...
func (obj *ServiceConnectionModule) AddTag(
	...
	if obj.modified.Bit(service_connection_module_tag_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, service_connection_module_tag_refs, 1)
	return nil
}
...
func (obj *ServiceConnectionModule) ClearTag() {
	if (obj.valid.Bit(service_connection_module_tag_refs) != 0) &&
		(obj.modified.Bit(service_connection_module_tag_refs) == 0) {
		obj.storeReferenceBase("tag", obj.tag_refs)
	}
	obj.tag_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, service_connection_module_tag_refs, 1)
	obj.modified.SetBit(&obj.modified, service_connection_module_tag_refs, 1)
}
...
func (obj *ServiceConnectionModule) readServiceEndpointBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_connection_module_service_endpoint_back_refs) == 0) {
...
func (obj *ServiceConnectionModule) MarshalJSON() ([]byte, error) {
	...
	if obj.modified.Bit(service_connection_module_e2_service) != 0 {
	...
	if obj.modified.Bit(service_connection_module_service_type) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(service_connection_module_id_perms) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(service_connection_module_perms2) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(service_connection_module_annotations) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(service_connection_module_display_name) != 0 {
		var value json.RawMessage
...
func (obj *ServiceConnectionModule) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "e2_service":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_connection_module_e2_service, 1)
			}
			break
		case "service_type":
			err = json.Unmarshal(value, &obj.service_type)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_connection_module_service_type, 1)
			}
			break
		case "id_perms":
			err = json.Unmarshal(value, &obj.id_perms)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_connection_module_id_perms, 1)
			}
			break
		case "perms2":
			err = json.Unmarshal(value, &obj.perms2)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_connection_module_perms2, 1)
			}
			break
		case "annotations":
			err = json.Unmarshal(value, &obj.annotations)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_connection_module_annotations, 1)
			}
			break
		case "display_name":
			err = json.Unmarshal(value, &obj.display_name)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_connection_module_display_name, 1)
			}
			break
		...
		case "service_endpoint_back_refs":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_connection_module_service_endpoint_back_refs, 1)
			}
			break
		}
		if err != nil {
