...
const (
	virtual_ip_virtual_ip_properties int = iota
	virtual_ip_id_perms
	virtual_ip_perms2
...
func (obj *VirtualIp) SetVirtualIpProperties(value *VirtualIpType) {
	...
	obj.modified.SetBit(&obj.modified, virtual_ip_virtual_ip_properties, 1)
}
...
func (obj *VirtualIp) SetIdPerms(value *IdPermsType) {
	obj.id_perms = *value
	obj.modified.SetBit(&obj.modified, virtual_ip_id_perms, 1)
}
...
func (obj *VirtualIp) SetPerms2(value *PermType2) {
	obj.perms2 = *value
	obj.modified.SetBit(&obj.modified, virtual_ip_perms2, 1)
}
...
func (obj *VirtualIp) SetAnnotations(value *KeyValuePairs) {
	...
	obj.modified.SetBit(&obj.modified, virtual_ip_annotations, 1)
}
...
func (obj *VirtualIp) SetDisplayName(value string) {
	...
	obj.modified.SetBit(&obj.modified, virtual_ip_display_name, 1)
}

func (obj *VirtualIp) readLoadbalancerPoolRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(virtual_ip_loadbalancer_pool_refs) == 0) {
...
func (obj *VirtualIp) AddLoadbalancerPool(
	...
	if obj.modified.Bit(virtual_ip_loadbalancer_pool_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, virtual_ip_loadbalancer_pool_refs, 1)
	return nil
}
...
func (obj *VirtualIp) ClearLoadbalancerPool() {
	if (obj.valid.Bit(virtual_ip_loadbalancer_pool_refs) != 0) &&
		(obj.modified.Bit(virtual_ip_loadbalancer_pool_refs) == 0) {
		obj.storeReferenceBase("loadbalancer-pool", obj.loadbalancer_pool_refs)
	}
	obj.loadbalancer_pool_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, virtual_ip_loadbalancer_pool_refs, 1)
	obj.modified.SetBit(&obj.modified, virtual_ip_loadbalancer_pool_refs, 1)
}
...
func (obj *VirtualIp) readVirtualMachineInterfaceRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(virtual_ip_virtual_machine_interface_refs) == 0) {
...
func (obj *VirtualIp) AddVirtualMachineInterface(
	...
	if obj.modified.Bit(virtual_ip_virtual_machine_interface_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, virtual_ip_virtual_machine_interface_refs, 1)
	return nil
}
...
func (obj *VirtualIp) ClearVirtualMachineInterface() {
	if (obj.valid.Bit(virtual_ip_virtual_machine_interface_refs) != 0) &&
		(obj.modified.Bit(virtual_ip_virtual_machine_interface_refs) == 0) {
		obj.storeReferenceBase("virtual-machine-interface", obj.virtual_machine_interface_refs)
	}
	obj.virtual_machine_interface_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, virtual_ip_virtual_machine_interface_refs, 1)
	obj.modified.SetBit(&obj.modified, virtual_ip_virtual_machine_interface_refs, 1)
}
...
func (obj *VirtualIp) readTagRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(virtual_ip_tag_refs) == 0) {
...
func (obj *VirtualIp) AddTag(
	...
	if obj.modified.Bit(virtual_ip_tag_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, virtual_ip_tag_refs, 1)
	return nil
}
...
func (obj *VirtualIp) ClearTag() {
	if (obj.valid.Bit(virtual_ip_tag_refs) != 0) &&
		(obj.modified.Bit(virtual_ip_tag_refs) == 0) {
		obj.storeReferenceBase("tag", obj.tag_refs)
	}
	obj.tag_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, virtual_ip_tag_refs, 1)
	obj.modified.SetBit(&obj.modified, virtual_ip_tag_refs, 1)
}
...
func (obj *VirtualIp) MarshalJSON() ([]byte, error) {
	...
	if obj.modified.Bit(virtual_ip_virtual_ip_properties) != 0 {
	...
	if obj.modified.Bit(virtual_ip_id_perms) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(virtual_ip_perms2) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(virtual_ip_annotations) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(virtual_ip_display_name) != 0 {
		var value json.RawMessage
...
func (obj *VirtualIp) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "virtual_ip_properties":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, virtual_ip_virtual_ip_properties, 1)
			}
			break
		case "id_perms":
			err = json.Unmarshal(value, &obj.id_perms)
			if err == nil {
				obj.valid.SetBit(&obj.valid, virtual_ip_id_perms, 1)
			}
			break
		case "perms2":
			err = json.Unmarshal(value, &obj.perms2)
			if err == nil {
				obj.valid.SetBit(&obj.valid, virtual_ip_perms2, 1)
			}
			break
		case "annotations":
			err = json.Unmarshal(value, &obj.annotations)
			if err == nil {
				obj.valid.SetBit(&obj.valid, virtual_ip_annotations, 1)
			}
			break
		case "display_name":
			err = json.Unmarshal(value, &obj.display_name)
			if err == nil {
				obj.valid.SetBit(&obj.valid, virtual_ip_display_name, 1)
			}
			break
