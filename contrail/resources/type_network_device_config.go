...
const (
	network_device_config_id_perms int = iota
...
func (obj *NetworkDeviceConfig) SetIdPerms(value *IdPermsType) {
	obj.id_perms = *value
	obj.modified.SetBit(&obj.modified, network_device_config_id_perms, 1)
}
...
func (obj *NetworkDeviceConfig) SetPerms2(value *PermType2) {
	obj.perms2 = *value
	obj.modified.SetBit(&obj.modified, network_device_config_perms2, 1)
}
...
func (obj *NetworkDeviceConfig) SetAnnotations(value *KeyValuePairs) {
	...
	obj.modified.SetBit(&obj.modified, network_device_config_annotations, 1)
}
...
func (obj *NetworkDeviceConfig) SetDisplayName(value string) {
	...
	obj.modified.SetBit(&obj.modified, network_device_config_display_name, 1)
}

func (obj *NetworkDeviceConfig) readPhysicalRouterRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(network_device_config_physical_router_refs) == 0) {
...
func (obj *NetworkDeviceConfig) AddPhysicalRouter(
	...
	if obj.modified.Bit(network_device_config_physical_router_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, network_device_config_physical_router_refs, 1)
	return nil
}
...
func (obj *NetworkDeviceConfig) ClearPhysicalRouter() {
	if (obj.valid.Bit(network_device_config_physical_router_refs) != 0) &&
		(obj.modified.Bit(network_device_config_physical_router_refs) == 0) {
		obj.storeReferenceBase("physical-router", obj.physical_router_refs)
	}
	obj.physical_router_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, network_device_config_physical_router_refs, 1)
	obj.modified.SetBit(&obj.modified, network_device_config_physical_router_refs, 1)
}
...
func (obj *NetworkDeviceConfig) readTagRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(network_device_config_tag_refs) == 0) {
...
func (obj *NetworkDeviceConfig) AddTag(
	...
	if obj.modified.Bit(network_device_config_tag_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, network_device_config_tag_refs, 1)
	return nil
}
...
func (obj *NetworkDeviceConfig) ClearTag() {
	if (obj.valid.Bit(network_device_config_tag_refs) != 0) &&
		(obj.modified.Bit(network_device_config_tag_refs) == 0) {
		obj.storeReferenceBase("tag", obj.tag_refs)
	}
	obj.tag_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, network_device_config_tag_refs, 1)
	obj.modified.SetBit(&obj.modified, network_device_config_tag_refs, 1)
}
...
func (obj *NetworkDeviceConfig) MarshalJSON() ([]byte, error) {
	...
	if obj.modified.Bit(network_device_config_id_perms) != 0 {
	...
	if obj.modified.Bit(network_device_config_perms2) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(network_device_config_annotations) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(network_device_config_display_name) != 0 {
		var value json.RawMessage
...
func (obj *NetworkDeviceConfig) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "id_perms":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, network_device_config_id_perms, 1)
			}
			break
		case "perms2":
			err = json.Unmarshal(value, &obj.perms2)
			if err == nil {
				obj.valid.SetBit(&obj.valid, network_device_config_perms2, 1)
			}
			break
		case "annotations":
			err = json.Unmarshal(value, &obj.annotations)
			if err == nil {
				obj.valid.SetBit(&obj.valid, network_device_config_annotations, 1)
			}
			break
		case "display_name":
			err = json.Unmarshal(value, &obj.display_name)
			if err == nil {
				obj.valid.SetBit(&obj.valid, network_device_config_display_name, 1)
			}
			break
