...
const (
	service_endpoint_id_perms int = iota
...
func (obj *ServiceEndpoint) SetIdPerms(value *IdPermsType) {
	obj.id_perms = *value
	obj.modified.SetBit(&obj.modified, service_endpoint_id_perms, 1)
}
...
func (obj *ServiceEndpoint) SetPerms2(value *PermType2) {
	obj.perms2 = *value
	obj.modified.SetBit(&obj.modified, service_endpoint_perms2, 1)
}
...
func (obj *ServiceEndpoint) SetAnnotations(value *KeyValuePairs) {
	...
	obj.modified.SetBit(&obj.modified, service_endpoint_annotations, 1)
}
...
func (obj *ServiceEndpoint) SetDisplayName(value string) {
	...
	obj.modified.SetBit(&obj.modified, service_endpoint_display_name, 1)
}

func (obj *ServiceEndpoint) readServiceConnectionModuleRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_endpoint_service_connection_module_refs) == 0) {
...
func (obj *ServiceEndpoint) AddServiceConnectionModule(
	...
	if obj.modified.Bit(service_endpoint_service_connection_module_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, service_endpoint_service_connection_module_refs, 1)
	return nil
}
...
func (obj *ServiceEndpoint) ClearServiceConnectionModule() {
	if (obj.valid.Bit(service_endpoint_service_connection_module_refs) != 0) &&
		(obj.modified.Bit(service_endpoint_service_connection_module_refs) == 0) {
		obj.storeReferenceBase("service-connection-module", obj.service_connection_module_refs)
	}
	obj.service_connection_module_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, service_endpoint_service_connection_module_refs, 1)
	obj.modified.SetBit(&obj.modified, service_endpoint_service_connection_module_refs, 1)
}
...
func (obj *ServiceEndpoint) readPhysicalRouterRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_endpoint_physical_router_refs) == 0) {
...
func (obj *ServiceEndpoint) AddPhysicalRouter(
	...
	if obj.modified.Bit(service_endpoint_physical_router_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, service_endpoint_physical_router_refs, 1)
	return nil
}
...
func (obj *ServiceEndpoint) ClearPhysicalRouter() {
	if (obj.valid.Bit(service_endpoint_physical_router_refs) != 0) &&
		(obj.modified.Bit(service_endpoint_physical_router_refs) == 0) {
		obj.storeReferenceBase("physical-router", obj.physical_router_refs)
	}
	obj.physical_router_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, service_endpoint_physical_router_refs, 1)
	obj.modified.SetBit(&obj.modified, service_endpoint_physical_router_refs, 1)
}
...
func (obj *ServiceEndpoint) readServiceObjectRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_endpoint_service_object_refs) == 0) {
...
func (obj *ServiceEndpoint) AddServiceObject(
	...
	if obj.modified.Bit(service_endpoint_service_object_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, service_endpoint_service_object_refs, 1)
	return nil
}
...
func (obj *ServiceEndpoint) ClearServiceObject() {
	if (obj.valid.Bit(service_endpoint_service_object_refs) != 0) &&
		(obj.modified.Bit(service_endpoint_service_object_refs) == 0) {
		obj.storeReferenceBase("service-object", obj.service_object_refs)
	}
	obj.service_object_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, service_endpoint_service_object_refs, 1)
	obj.modified.SetBit(&obj.modified, service_endpoint_service_object_refs, 1)
}
...
func (obj *ServiceEndpoint) readTagRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_endpoint_tag_refs) == 0) {
...
func (obj *ServiceEndpoint) AddTag(
	...
	if obj.modified.Bit(service_endpoint_tag_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, service_endpoint_tag_refs, 1)
	return nil
}
...
func (obj *ServiceEndpoint) ClearTag() {
	if (obj.valid.Bit(service_endpoint_tag_refs) != 0) &&
		(obj.modified.Bit(service_endpoint_tag_refs) == 0) {
		obj.storeReferenceBase("tag", obj.tag_refs)
	}
	obj.tag_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, service_endpoint_tag_refs, 1)
	obj.modified.SetBit(&obj.modified, service_endpoint_tag_refs, 1)
}
...
func (obj *ServiceEndpoint) readVirtualMachineInterfaceBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_endpoint_virtual_machine_interface_back_refs) == 0) {
...
func (obj *ServiceEndpoint) MarshalJSON() ([]byte, error) {
	...
	if obj.modified.Bit(service_endpoint_id_perms) != 0 {
	...
	if obj.modified.Bit(service_endpoint_perms2) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(service_endpoint_annotations) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(service_endpoint_display_name) != 0 {
		var value json.RawMessage
...
func (obj *ServiceEndpoint) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "id_perms":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_endpoint_id_perms, 1)
			}
			break
		case "perms2":
			err = json.Unmarshal(value, &obj.perms2)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_endpoint_perms2, 1)
			}
			break
		case "annotations":
			err = json.Unmarshal(value, &obj.annotations)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_endpoint_annotations, 1)
			}
			break
		case "display_name":
			err = json.Unmarshal(value, &obj.display_name)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_endpoint_display_name, 1)
			}
			break
		...
		case "virtual_machine_interface_back_refs":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_endpoint_virtual_machine_interface_back_refs, 1)
			}
			break
		}
		if err != nil {
