...
const (
	loadbalancer_loadbalancer_properties int = iota
...
func (obj *Loadbalancer) SetLoadbalancerProperties(value *LoadbalancerType) {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_loadbalancer_properties, 1)
}
...
func (obj *Loadbalancer) SetLoadbalancerProvider(value string) {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_loadbalancer_provider, 1)
}
...
func (obj *Loadbalancer) SetIdPerms(value *IdPermsType) {
	obj.id_perms = *value
	obj.modified.SetBit(&obj.modified, loadbalancer_id_perms, 1)
}
...
func (obj *Loadbalancer) SetPerms2(value *PermType2) {
	obj.perms2 = *value
	obj.modified.SetBit(&obj.modified, loadbalancer_perms2, 1)
}
...
func (obj *Loadbalancer) SetAnnotations(value *KeyValuePairs) {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_annotations, 1)
}
...
func (obj *Loadbalancer) SetDisplayName(value string) {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_display_name, 1)
}

func (obj *Loadbalancer) readServiceApplianceSetRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(loadbalancer_service_appliance_set_refs) == 0) {
...
func (obj *Loadbalancer) AddServiceApplianceSet(
	...
	if obj.modified.Bit(loadbalancer_service_appliance_set_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_service_appliance_set_refs, 1)
	return nil
}
...
func (obj *Loadbalancer) ClearServiceApplianceSet() {
	if (obj.valid.Bit(loadbalancer_service_appliance_set_refs) != 0) &&
		(obj.modified.Bit(loadbalancer_service_appliance_set_refs) == 0) {
		obj.storeReferenceBase("service-appliance-set", obj.service_appliance_set_refs)
	}
	obj.service_appliance_set_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, loadbalancer_service_appliance_set_refs, 1)
	obj.modified.SetBit(&obj.modified, loadbalancer_service_appliance_set_refs, 1)
}
...
func (obj *Loadbalancer) readServiceInstanceRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(loadbalancer_service_instance_refs) == 0) {
...
func (obj *Loadbalancer) AddServiceInstance(
	...
	if obj.modified.Bit(loadbalancer_service_instance_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_service_instance_refs, 1)
	return nil
}
...
func (obj *Loadbalancer) ClearServiceInstance() {
	if (obj.valid.Bit(loadbalancer_service_instance_refs) != 0) &&
		(obj.modified.Bit(loadbalancer_service_instance_refs) == 0) {
		obj.storeReferenceBase("service-instance", obj.service_instance_refs)
	}
	obj.service_instance_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, loadbalancer_service_instance_refs, 1)
	obj.modified.SetBit(&obj.modified, loadbalancer_service_instance_refs, 1)
}
...
func (obj *Loadbalancer) readVirtualMachineInterfaceRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(loadbalancer_virtual_machine_interface_refs) == 0) {
...
func (obj *Loadbalancer) AddVirtualMachineInterface(
	...
	if obj.modified.Bit(loadbalancer_virtual_machine_interface_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_virtual_machine_interface_refs, 1)
	return nil
}
...
func (obj *Loadbalancer) ClearVirtualMachineInterface() {
	if (obj.valid.Bit(loadbalancer_virtual_machine_interface_refs) != 0) &&
		(obj.modified.Bit(loadbalancer_virtual_machine_interface_refs) == 0) {
		obj.storeReferenceBase("virtual-machine-interface", obj.virtual_machine_interface_refs)
	}
	obj.virtual_machine_interface_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, loadbalancer_virtual_machine_interface_refs, 1)
	obj.modified.SetBit(&obj.modified, loadbalancer_virtual_machine_interface_refs, 1)
}
...
func (obj *Loadbalancer) readTagRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(loadbalancer_tag_refs) == 0) {
...
func (obj *Loadbalancer) AddTag(
	...
	if obj.modified.Bit(loadbalancer_tag_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_tag_refs, 1)
	return nil
}
...
func (obj *Loadbalancer) ClearTag() {
	if (obj.valid.Bit(loadbalancer_tag_refs) != 0) &&
		(obj.modified.Bit(loadbalancer_tag_refs) == 0) {
		obj.storeReferenceBase("tag", obj.tag_refs)
	}
	obj.tag_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, loadbalancer_tag_refs, 1)
	obj.modified.SetBit(&obj.modified, loadbalancer_tag_refs, 1)
}
...
func (obj *Loadbalancer) readLoadbalancerListenerBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(loadbalancer_loadbalancer_listener_back_refs) == 0) {
...
func (obj *Loadbalancer) MarshalJSON() ([]byte, error) {
	...
	if obj.modified.Bit(loadbalancer_loadbalancer_properties) != 0 {
	...
	if obj.modified.Bit(loadbalancer_loadbalancer_provider) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(loadbalancer_id_perms) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(loadbalancer_perms2) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(loadbalancer_annotations) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(loadbalancer_display_name) != 0 {
		var value json.RawMessage
...
func (obj *Loadbalancer) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "loadbalancer_properties":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_loadbalancer_properties, 1)
			}
			break
		case "loadbalancer_provider":
			err = json.Unmarshal(value, &obj.loadbalancer_provider)
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_loadbalancer_provider, 1)
			}
			break
		case "id_perms":
			err = json.Unmarshal(value, &obj.id_perms)
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_id_perms, 1)
			}
			break
		case "perms2":
			err = json.Unmarshal(value, &obj.perms2)
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_perms2, 1)
			}
			break
		case "annotations":
			err = json.Unmarshal(value, &obj.annotations)
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_annotations, 1)
			}
			break
		case "display_name":
			err = json.Unmarshal(value, &obj.display_name)
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_display_name, 1)
			}
			break
		...
		case "loadbalancer_listener_back_refs":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_loadbalancer_listener_back_refs, 1)
			}
			break
		}
		if err != nil {
