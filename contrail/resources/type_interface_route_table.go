...
const (
	interface_route_table_interface_route_table_routes int = iota
...
func (obj *InterfaceRouteTable) SetInterfaceRouteTableRoutes(value *RouteTableType) {
	...
	obj.modified.SetBit(&obj.modified, interface_route_table_interface_route_table_routes, 1)
}
...
func (obj *InterfaceRouteTable) SetIdPerms(value *IdPermsType) {
	obj.id_perms = *value
	obj.modified.SetBit(&obj.modified, interface_route_table_id_perms, 1)
}
...
func (obj *InterfaceRouteTable) SetPerms2(value *PermType2) {
	obj.perms2 = *value
	obj.modified.SetBit(&obj.modified, interface_route_table_perms2, 1)
}
...
func (obj *InterfaceRouteTable) SetAnnotations(value *KeyValuePairs) {
	...
	obj.modified.SetBit(&obj.modified, interface_route_table_annotations, 1)
}
...
func (obj *InterfaceRouteTable) SetDisplayName(value string) {
	...
	obj.modified.SetBit(&obj.modified, interface_route_table_display_name, 1)
}

func (obj *InterfaceRouteTable) readServiceInstanceRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(interface_route_table_service_instance_refs) == 0) {
...
func (obj *InterfaceRouteTable) AddServiceInstance(
	...
	if obj.modified.Bit(interface_route_table_service_instance_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, interface_route_table_service_instance_refs, 1)
	return nil
}
...
func (obj *InterfaceRouteTable) ClearServiceInstance() {
	if (obj.valid.Bit(interface_route_table_service_instance_refs) != 0) &&
		(obj.modified.Bit(interface_route_table_service_instance_refs) == 0) {
		obj.storeReferenceBase("service-instance", obj.service_instance_refs)
	}
	obj.service_instance_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, interface_route_table_service_instance_refs, 1)
	obj.modified.SetBit(&obj.modified, interface_route_table_service_instance_refs, 1)
}
...
func (obj *InterfaceRouteTable) readTagRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(interface_route_table_tag_refs) == 0) {
...
func (obj *InterfaceRouteTable) AddTag(
	...
	if obj.modified.Bit(interface_route_table_tag_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, interface_route_table_tag_refs, 1)
	return nil
}
...
func (obj *InterfaceRouteTable) ClearTag() {
	if (obj.valid.Bit(interface_route_table_tag_refs) != 0) &&
		(obj.modified.Bit(interface_route_table_tag_refs) == 0) {
		obj.storeReferenceBase("tag", obj.tag_refs)
	}
	obj.tag_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, interface_route_table_tag_refs, 1)
	obj.modified.SetBit(&obj.modified, interface_route_table_tag_refs, 1)
}
...
func (obj *InterfaceRouteTable) readVirtualMachineInterfaceBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(interface_route_table_virtual_machine_interface_back_refs) == 0) {
...
func (obj *InterfaceRouteTable) MarshalJSON() ([]byte, error) {
	...
	if obj.modified.Bit(interface_route_table_interface_route_table_routes) != 0 {
	...
	if obj.modified.Bit(interface_route_table_id_perms) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(interface_route_table_perms2) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(interface_route_table_annotations) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(interface_route_table_display_name) != 0 {
		var value json.RawMessage
...
func (obj *InterfaceRouteTable) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "interface_route_table_routes":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, interface_route_table_interface_route_table_routes, 1)
			}
			break
		case "id_perms":
			err = json.Unmarshal(value, &obj.id_perms)
			if err == nil {
				obj.valid.SetBit(&obj.valid, interface_route_table_id_perms, 1)
			}
			break
		case "perms2":
			err = json.Unmarshal(value, &obj.perms2)
			if err == nil {
				obj.valid.SetBit(&obj.valid, interface_route_table_perms2, 1)
			}
			break
		case "annotations":
			err = json.Unmarshal(value, &obj.annotations)
			if err == nil {
				obj.valid.SetBit(&obj.valid, interface_route_table_annotations, 1)
			}
			break
		case "display_name":
			err = json.Unmarshal(value, &obj.display_name)
			if err == nil {
				obj.valid.SetBit(&obj.valid, interface_route_table_display_name, 1)
			}
			break
		case "tag_refs":
		...
		case "virtual_machine_interface_back_refs":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, interface_route_table_virtual_machine_interface_back_refs, 1)
			}
			break
