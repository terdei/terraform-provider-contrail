...
const (
	service_instance_service_instance_properties int = iota
...
func (obj *ServiceInstance) SetServiceInstanceProperties(value *ServiceInstanceType) {
	...
	obj.modified.SetBit(&obj.modified, service_instance_service_instance_properties, 1)
}
...
func (obj *ServiceInstance) SetServiceInstanceBindings(value *KeyValuePairs) {
	...
	obj.modified.SetBit(&obj.modified, service_instance_service_instance_bindings, 1)
}
...
func (obj *ServiceInstance) SetIdPerms(value *IdPermsType) {
	obj.id_perms = *value
	obj.modified.SetBit(&obj.modified, service_instance_id_perms, 1)
}
...
func (obj *ServiceInstance) SetPerms2(value *PermType2) {
	obj.perms2 = *value
	obj.modified.SetBit(&obj.modified, service_instance_perms2, 1)
}
...
func (obj *ServiceInstance) SetAnnotations(value *KeyValuePairs) {
	...
	obj.modified.SetBit(&obj.modified, service_instance_annotations, 1)
}
...
func (obj *ServiceInstance) SetDisplayName(value string) {
	...
	obj.modified.SetBit(&obj.modified, service_instance_display_name, 1)
}

func (obj *ServiceInstance) readPortTuples() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_instance_port_tuples) == 0) {
...
func (obj *ServiceInstance) readServiceTemplateRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_instance_service_template_refs) == 0) {
...
func (obj *ServiceInstance) AddServiceTemplate(
	...
	if obj.modified.Bit(service_instance_service_template_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, service_instance_service_template_refs, 1)
	return nil
}
...
func (obj *ServiceInstance) ClearServiceTemplate() {
	if (obj.valid.Bit(service_instance_service_template_refs) != 0) &&
		(obj.modified.Bit(service_instance_service_template_refs) == 0) {
		obj.storeReferenceBase("service-template", obj.service_template_refs)
	}
	obj.service_template_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, service_instance_service_template_refs, 1)
	obj.modified.SetBit(&obj.modified, service_instance_service_template_refs, 1)
}
...
func (obj *ServiceInstance) readInstanceIpRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_instance_instance_ip_refs) == 0) {
...
func (obj *ServiceInstance) AddInstanceIp(
	...
	if obj.modified.Bit(service_instance_instance_ip_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, service_instance_instance_ip_refs, 1)
	return nil
}
...
func (obj *ServiceInstance) ClearInstanceIp() {
	if (obj.valid.Bit(service_instance_instance_ip_refs) != 0) &&
		(obj.modified.Bit(service_instance_instance_ip_refs) == 0) {
		obj.storeReferenceBase("instance-ip", obj.instance_ip_refs)
	}
	obj.instance_ip_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, service_instance_instance_ip_refs, 1)
	obj.modified.SetBit(&obj.modified, service_instance_instance_ip_refs, 1)
}
...
func (obj *ServiceInstance) readTagRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_instance_tag_refs) == 0) {
...
func (obj *ServiceInstance) AddTag(
	...
	if obj.modified.Bit(service_instance_tag_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, service_instance_tag_refs, 1)
	return nil
}
...
func (obj *ServiceInstance) ClearTag() {
	if (obj.valid.Bit(service_instance_tag_refs) != 0) &&
		(obj.modified.Bit(service_instance_tag_refs) == 0) {
		obj.storeReferenceBase("tag", obj.tag_refs)
	}
	obj.tag_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, service_instance_tag_refs, 1)
	obj.modified.SetBit(&obj.modified, service_instance_tag_refs, 1)
}
...
func (obj *ServiceInstance) readVirtualMachineBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_instance_virtual_machine_back_refs) == 0) {
...
func (obj *ServiceInstance) readServiceHealthCheckBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_instance_service_health_check_back_refs) == 0) {
...
func (obj *ServiceInstance) readInterfaceRouteTableBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_instance_interface_route_table_back_refs) == 0) {
...
func (obj *ServiceInstance) readRoutingPolicyBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_instance_routing_policy_back_refs) == 0) {
...
func (obj *ServiceInstance) readRouteAggregateBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_instance_route_aggregate_back_refs) == 0) {
...
func (obj *ServiceInstance) readLogicalRouterBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_instance_logical_router_back_refs) == 0) {
...
func (obj *ServiceInstance) readLoadbalancerPoolBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_instance_loadbalancer_pool_back_refs) == 0) {
...
func (obj *ServiceInstance) readLoadbalancerBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_instance_loadbalancer_back_refs) == 0) {
...
func (obj *ServiceInstance) MarshalJSON() ([]byte, error) {
	...
	if obj.modified.Bit(service_instance_service_instance_properties) != 0 {
	...
	if obj.modified.Bit(service_instance_service_instance_bindings) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(service_instance_id_perms) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(service_instance_perms2) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(service_instance_annotations) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(service_instance_display_name) != 0 {
		var value json.RawMessage
...
func (obj *ServiceInstance) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "service_instance_properties":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_instance_service_instance_properties, 1)
			}
			break
		case "service_instance_bindings":
			err = json.Unmarshal(value, &obj.service_instance_bindings)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_instance_service_instance_bindings, 1)
			}
			break
		case "id_perms":
			err = json.Unmarshal(value, &obj.id_perms)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_instance_id_perms, 1)
			}
			break
		case "perms2":
			err = json.Unmarshal(value, &obj.perms2)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_instance_perms2, 1)
			}
			break
		case "annotations":
			err = json.Unmarshal(value, &obj.annotations)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_instance_annotations, 1)
			}
			break
		case "display_name":
			err = json.Unmarshal(value, &obj.display_name)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_instance_display_name, 1)
			}
			break
		...
		case "port_tuples":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_instance_port_tuples, 1)
			}
			break
		case "tag_refs":
		...
		case "virtual_machine_back_refs":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_instance_virtual_machine_back_refs, 1)
			}
			break
		case "logical_router_back_refs":
			err = json.Unmarshal(value, &obj.logical_router_back_refs)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_instance_logical_router_back_refs, 1)
			}
			break
		case "loadbalancer_pool_back_refs":
			err = json.Unmarshal(value, &obj.loadbalancer_pool_back_refs)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_instance_loadbalancer_pool_back_refs, 1)
			}
			break
		case "loadbalancer_back_refs":
			err = json.Unmarshal(value, &obj.loadbalancer_back_refs)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_instance_loadbalancer_back_refs, 1)
			}
			break
		...
		case "service_health_check_back_refs":
			{
				...
				obj.valid.SetBit(&obj.valid, service_instance_service_health_check_back_refs, 1)
		...
		case "interface_route_table_back_refs":
			{
				...
				obj.valid.SetBit(&obj.valid, service_instance_interface_route_table_back_refs, 1)
		...
		case "routing_policy_back_refs":
			{
				...
				obj.valid.SetBit(&obj.valid, service_instance_routing_policy_back_refs, 1)
		...
		case "route_aggregate_back_refs":
			{
				...
				obj.valid.SetBit(&obj.valid, service_instance_route_aggregate_back_refs, 1)
