...
const (
	provider_attachment_id_perms int = iota
...
func (obj *ProviderAttachment) SetIdPerms(value *IdPermsType) {
	obj.id_perms = *value
	obj.modified.SetBit(&obj.modified, provider_attachment_id_perms, 1)
}
...
func (obj *ProviderAttachment) SetPerms2(value *PermType2) {
	obj.perms2 = *value
	obj.modified.SetBit(&obj.modified, provider_attachment_perms2, 1)
}
...
func (obj *ProviderAttachment) SetAnnotations(value *KeyValuePairs) {
	...
	obj.modified.SetBit(&obj.modified, provider_attachment_annotations, 1)
}
...
func (obj *ProviderAttachment) SetDisplayName(value string) {
	...
	obj.modified.SetBit(&obj.modified, provider_attachment_display_name, 1)
}

func (obj *ProviderAttachment) readVirtualRouterRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(provider_attachment_virtual_router_refs) == 0) {
...
func (obj *ProviderAttachment) AddVirtualRouter(
	...
	if obj.modified.Bit(provider_attachment_virtual_router_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, provider_attachment_virtual_router_refs, 1)
	return nil
}
...
func (obj *ProviderAttachment) ClearVirtualRouter() {
	if (obj.valid.Bit(provider_attachment_virtual_router_refs) != 0) &&
		(obj.modified.Bit(provider_attachment_virtual_router_refs) == 0) {
		obj.storeReferenceBase("virtual-router", obj.virtual_router_refs)
	}
...
func (obj *ProviderAttachment) MarshalJSON() ([]byte, error) {
	...
	if obj.modified.Bit(provider_attachment_id_perms) != 0 {
	...
	if obj.modified.Bit(provider_attachment_perms2) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(provider_attachment_annotations) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(provider_attachment_display_name) != 0 {
		var value json.RawMessage
...
func (obj *ProviderAttachment) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "id_perms":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, provider_attachment_id_perms, 1)
			}
			break
		case "perms2":
			err = json.Unmarshal(value, &obj.perms2)
			if err == nil {
				obj.valid.SetBit(&obj.valid, provider_attachment_perms2, 1)
			}
			break
		case "annotations":
			err = json.Unmarshal(value, &obj.annotations)
			if err == nil {
				obj.valid.SetBit(&obj.valid, provider_attachment_annotations, 1)
			}
			break
		case "display_name":
			err = json.Unmarshal(value, &obj.display_name)
			if err == nil {
				obj.valid.SetBit(&obj.valid, provider_attachment_display_name, 1)
			}
			break
