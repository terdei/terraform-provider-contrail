...
const (
	loadbalancer_pool_loadbalancer_pool_properties int = iota
...
func (obj *LoadbalancerPool) SetLoadbalancerPoolProperties(value *LoadbalancerPoolType) {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_loadbalancer_pool_properties, 1)
}
...
func (obj *LoadbalancerPool) SetLoadbalancerPoolProvider(value string) {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_loadbalancer_pool_provider, 1)
}
...
func (obj *LoadbalancerPool) SetLoadbalancerPoolCustomAttributes(value *KeyValuePairs) {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_loadbalancer_pool_custom_attributes, 1)
}
...
func (obj *LoadbalancerPool) SetIdPerms(value *IdPermsType) {
	obj.id_perms = *value
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_id_perms, 1)
}
...
func (obj *LoadbalancerPool) SetPerms2(value *PermType2) {
	obj.perms2 = *value
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_perms2, 1)
}
...
func (obj *LoadbalancerPool) SetAnnotations(value *KeyValuePairs) {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_annotations, 1)
}
...
func (obj *LoadbalancerPool) SetDisplayName(value string) {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_display_name, 1)
}

func (obj *LoadbalancerPool) readLoadbalancerMembers() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(loadbalancer_pool_loadbalancer_members) == 0) {
...
func (obj *LoadbalancerPool) readServiceInstanceRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(loadbalancer_pool_service_instance_refs) == 0) {
...
func (obj *LoadbalancerPool) AddServiceInstance(
	...
	if obj.modified.Bit(loadbalancer_pool_service_instance_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_service_instance_refs, 1)
	return nil
}
...
func (obj *LoadbalancerPool) ClearServiceInstance() {
	if (obj.valid.Bit(loadbalancer_pool_service_instance_refs) != 0) &&
		(obj.modified.Bit(loadbalancer_pool_service_instance_refs) == 0) {
		obj.storeReferenceBase("service-instance", obj.service_instance_refs)
	}
	obj.service_instance_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, loadbalancer_pool_service_instance_refs, 1)
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_service_instance_refs, 1)
}
...
func (obj *LoadbalancerPool) readVirtualMachineInterfaceRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(loadbalancer_pool_virtual_machine_interface_refs) == 0) {
...
func (obj *LoadbalancerPool) AddVirtualMachineInterface(
	...
	if obj.modified.Bit(loadbalancer_pool_virtual_machine_interface_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_virtual_machine_interface_refs, 1)
	return nil
}
...
func (obj *LoadbalancerPool) ClearVirtualMachineInterface() {
	if (obj.valid.Bit(loadbalancer_pool_virtual_machine_interface_refs) != 0) &&
		(obj.modified.Bit(loadbalancer_pool_virtual_machine_interface_refs) == 0) {
		obj.storeReferenceBase("virtual-machine-interface", obj.virtual_machine_interface_refs)
	}
	obj.virtual_machine_interface_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, loadbalancer_pool_virtual_machine_interface_refs, 1)
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_virtual_machine_interface_refs, 1)
}
...
func (obj *LoadbalancerPool) readLoadbalancerListenerRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(loadbalancer_pool_loadbalancer_listener_refs) == 0) {
...
func (obj *LoadbalancerPool) AddLoadbalancerListener(
	...
	if obj.modified.Bit(loadbalancer_pool_loadbalancer_listener_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_loadbalancer_listener_refs, 1)
	return nil
}
...
func (obj *LoadbalancerPool) ClearLoadbalancerListener() {
	if (obj.valid.Bit(loadbalancer_pool_loadbalancer_listener_refs) != 0) &&
		(obj.modified.Bit(loadbalancer_pool_loadbalancer_listener_refs) == 0) {
		obj.storeReferenceBase("loadbalancer-listener", obj.loadbalancer_listener_refs)
	}
	obj.loadbalancer_listener_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, loadbalancer_pool_loadbalancer_listener_refs, 1)
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_loadbalancer_listener_refs, 1)
}
...
func (obj *LoadbalancerPool) readServiceApplianceSetRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(loadbalancer_pool_service_appliance_set_refs) == 0) {
...
func (obj *LoadbalancerPool) AddServiceApplianceSet(
	...
	if obj.modified.Bit(loadbalancer_pool_service_appliance_set_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_service_appliance_set_refs, 1)
	return nil
}
...
func (obj *LoadbalancerPool) ClearServiceApplianceSet() {
	if (obj.valid.Bit(loadbalancer_pool_service_appliance_set_refs) != 0) &&
		(obj.modified.Bit(loadbalancer_pool_service_appliance_set_refs) == 0) {
		obj.storeReferenceBase("service-appliance-set", obj.service_appliance_set_refs)
	}
	obj.service_appliance_set_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, loadbalancer_pool_service_appliance_set_refs, 1)
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_service_appliance_set_refs, 1)
}
...
func (obj *LoadbalancerPool) readLoadbalancerHealthmonitorRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(loadbalancer_pool_loadbalancer_healthmonitor_refs) == 0) {
...
func (obj *LoadbalancerPool) AddLoadbalancerHealthmonitor(
	...
	if obj.modified.Bit(loadbalancer_pool_loadbalancer_healthmonitor_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, loadbalancer_pool_loadbalancer_healthmonitor_refs, 1)
	return nil
}
...
func (obj *LoadbalancerPool) ClearLoadbalancerHealthmonitor() {
	if (obj.valid.Bit(loadbalancer_pool_loadbalancer_healthmonitor_refs) != 0) &&
		(obj.modified.Bit(loadbalancer_pool_loadbalancer_healthmonitor_refs) == 0) {
		obj.storeReferenceBase("loadbalancer-healthmonitor", obj.loadbalancer_healthmonitor_refs)
	}
...
func (obj *LoadbalancerPool) MarshalJSON() ([]byte, error) {
	...
	if obj.modified.Bit(loadbalancer_pool_loadbalancer_pool_properties) != 0 {
	...
	if obj.modified.Bit(loadbalancer_pool_loadbalancer_pool_provider) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(loadbalancer_pool_loadbalancer_pool_custom_attributes) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(loadbalancer_pool_id_perms) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(loadbalancer_pool_perms2) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(loadbalancer_pool_annotations) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(loadbalancer_pool_display_name) != 0 {
		var value json.RawMessage
...
func (obj *LoadbalancerPool) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "loadbalancer_pool_properties":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_pool_loadbalancer_pool_properties, 1)
			}
			break
		case "loadbalancer_pool_provider":
			err = json.Unmarshal(value, &obj.loadbalancer_pool_provider)
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_pool_loadbalancer_pool_provider, 1)
			}
			break
		case "loadbalancer_pool_custom_attributes":
			err = json.Unmarshal(value, &obj.loadbalancer_pool_custom_attributes)
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_pool_loadbalancer_pool_custom_attributes, 1)
			}
			break
		case "id_perms":
			err = json.Unmarshal(value, &obj.id_perms)
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_pool_id_perms, 1)
			}
			break
		case "perms2":
			err = json.Unmarshal(value, &obj.perms2)
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_pool_perms2, 1)
			}
			break
		case "annotations":
			err = json.Unmarshal(value, &obj.annotations)
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_pool_annotations, 1)
			}
			break
		case "display_name":
			err = json.Unmarshal(value, &obj.display_name)
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_pool_display_name, 1)
			}
			break
		...
		case "loadbalancer_members":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_pool_loadbalancer_members, 1)
			}
			break
		...
		case "virtual_ip_back_refs":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, loadbalancer_pool_virtual_ip_back_refs, 1)
			}
			break
		}
		if err != nil {
