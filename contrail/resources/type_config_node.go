...
func (obj *ConfigNode) readTagRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(config_node_tag_refs) == 0) {
...
func (obj *ConfigNode) AddTag(
	...
	if obj.modified.Bit(config_node_tag_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, config_node_tag_refs, 1)
	return nil
}
...
func (obj *ConfigNode) ClearTag() {
	if (obj.valid.Bit(config_node_tag_refs) != 0) &&
		(obj.modified.Bit(config_node_tag_refs) == 0) {
		obj.storeReferenceBase("tag", obj.tag_refs)
	}
	obj.tag_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, config_node_tag_refs, 1)
	obj.modified.SetBit(&obj.modified, config_node_tag_refs, 1)
}
