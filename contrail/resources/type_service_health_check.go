...
const (
	service_health_check_service_health_check_properties int = iota
...
func (obj *ServiceHealthCheck) SetServiceHealthCheckProperties(value *ServiceHealthCheckType) {
	...
	obj.modified.SetBit(&obj.modified, service_health_check_service_health_check_properties, 1)
}
...
func (obj *ServiceHealthCheck) SetIdPerms(value *IdPermsType) {
	obj.id_perms = *value
	obj.modified.SetBit(&obj.modified, service_health_check_id_perms, 1)
}
...
func (obj *ServiceHealthCheck) SetPerms2(value *PermType2) {
	obj.perms2 = *value
	obj.modified.SetBit(&obj.modified, service_health_check_perms2, 1)
}
...
func (obj *ServiceHealthCheck) SetAnnotations(value *KeyValuePairs) {
	...
	obj.modified.SetBit(&obj.modified, service_health_check_annotations, 1)
}
...
func (obj *ServiceHealthCheck) SetDisplayName(value string) {
	...
	obj.modified.SetBit(&obj.modified, service_health_check_display_name, 1)
}

func (obj *ServiceHealthCheck) readServiceInstanceRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_health_check_service_instance_refs) == 0) {
...
func (obj *ServiceHealthCheck) AddServiceInstance(
	...
	if obj.modified.Bit(service_health_check_service_instance_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, service_health_check_service_instance_refs, 1)
	return nil
}
...
func (obj *ServiceHealthCheck) ClearServiceInstance() {
	if (obj.valid.Bit(service_health_check_service_instance_refs) != 0) &&
		(obj.modified.Bit(service_health_check_service_instance_refs) == 0) {
		obj.storeReferenceBase("service-instance", obj.service_instance_refs)
	}
	obj.service_instance_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, service_health_check_service_instance_refs, 1)
	obj.modified.SetBit(&obj.modified, service_health_check_service_instance_refs, 1)
}
...
func (obj *ServiceHealthCheck) readTagRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_health_check_tag_refs) == 0) {
...
func (obj *ServiceHealthCheck) AddTag(
	...
	if obj.modified.Bit(service_health_check_tag_refs) == 0 {
	...
	obj.modified.SetBit(&obj.modified, service_health_check_tag_refs, 1)
	return nil
}
...
func (obj *ServiceHealthCheck) ClearTag() {
	if (obj.valid.Bit(service_health_check_tag_refs) != 0) &&
		(obj.modified.Bit(service_health_check_tag_refs) == 0) {
		obj.storeReferenceBase("tag", obj.tag_refs)
	}
	obj.tag_refs = make([]contrail.Reference, 0)
	obj.valid.SetBit(&obj.valid, service_health_check_tag_refs, 1)
	obj.modified.SetBit(&obj.modified, service_health_check_tag_refs, 1)
}
...
func (obj *ServiceHealthCheck) readVirtualMachineInterfaceBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_health_check_virtual_machine_interface_back_refs) == 0) {
...
func (obj *ServiceHealthCheck) readBgpAsAServiceBackRefs() error {
	if !obj.IsTransient() &&
		(obj.valid.Bit(service_health_check_bgp_as_a_service_back_refs) == 0) {
...
func (obj *ServiceHealthCheck) MarshalJSON() ([]byte, error) {
	...
	if obj.modified.Bit(service_health_check_service_health_check_properties) != 0 {
	...
	if obj.modified.Bit(service_health_check_id_perms) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(service_health_check_perms2) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(service_health_check_annotations) != 0 {
		var value json.RawMessage
	...
	if obj.modified.Bit(service_health_check_display_name) != 0 {
		var value json.RawMessage
...
func (obj *ServiceHealthCheck) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "service_health_check_properties":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_health_check_service_health_check_properties, 1)
			}
			break
		case "id_perms":
			err = json.Unmarshal(value, &obj.id_perms)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_health_check_id_perms, 1)
			}
			break
		case "perms2":
			err = json.Unmarshal(value, &obj.perms2)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_health_check_perms2, 1)
			}
			break
		case "annotations":
			err = json.Unmarshal(value, &obj.annotations)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_health_check_annotations, 1)
			}
			break
		case "display_name":
			err = json.Unmarshal(value, &obj.display_name)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_health_check_display_name, 1)
			}
			break
		case "tag_refs":
		...
		case "virtual_machine_interface_back_refs":
			...
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_health_check_virtual_machine_interface_back_refs, 1)
			}
			break
		case "bgp_as_a_service_back_refs":
			err = json.Unmarshal(value, &obj.bgp_as_a_service_back_refs)
			if err == nil {
				obj.valid.SetBit(&obj.valid, service_health_check_bgp_as_a_service_back_refs, 1)
			}
			break
